...
#'  \item{x}{A full covariate matrix. It contains intercept, center(1: center 2, 0: center 1), sex (1: male,0: female), treat (1: treatment, 0: placebo), visit: id of each of four visits, baseline: resporatory status at baseline, age: in years at baseline.}
#'  \item{id}{Patient ID}
