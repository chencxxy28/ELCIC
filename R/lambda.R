...
#'@title To calculate tuning parameter in the empirical likelihood
#'@description This function aims to efficiently calculate the tuning parameter lambda in the empirical likelihood.
