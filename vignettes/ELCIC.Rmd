...
criterion.all<-ELCIC.glm.procedure(x=x,y=y,candidate.sets=candidate.sets,name.var=NULL,dist="poisson")
...
criterion.elcic<-ELCIC.gee.procedure(x=x,y=y,r=r,id=id,time=time,candidate.sets=candidate.sets,name.var=NULL,dist="poisson",candidate.cor.sets=candidate.cor.sets)

criterion.qic<-QIC.procedure(x=x,y=y,id=id,dist=dist,candidate.sets=candidate.sets, name.var=NULL, candidate.cor.sets=candidate.cor.sets)
